# Navegador Plongê — Storytelling para apresentação aos sócios

**Nota de nomenclatura:** o produto chama-se **Navegador** / **Navegador Plongê**. **Plia** é a camada de IA dentro desse produto. **Plia v1** refere-se ao sistema legado (Bluecore).
...
- O **Navegador** (com a **Plia** como IA) tem de ajudar a Plongê a **cuidar do que é mais importante no dia a dia** e a **potencializar essa rede**
...
- Gratidão ao que foi construído. E vamos **preservar o que deu certo**:
  ...
  - A interface do Plia v1 é bonita e tem a identidade da Plongê — vamos tirar prints de tudo e usar como referência de design para o **Navegador**
...
- KR2: Desenvolver o **Navegador** como CRM operacional (dados das ações comerciais e conceito de funil) dentro do 1o semestre
...
O **Navegador** mora no pilar de **Eficiência e Inovação**, mas serve todos os pilares:
...
- **Resultado: aquém do esperado**, e revelou um problema estrutural:
  - Usar ferramenta externa para o novo produto **enfraquece a proposta do Navegador** como central de conhecimento da Plongê
...
- Conclusão: o novo produto precisa ser construído **dentro do Navegador**

### Status atual do KR2: Navegador como CRM operacional

O KR2 do pilar de Eficiência e Inovação é "desenvolver o **Navegador** como CRM operacional (dados das ações comerciais e conceito de funil) dentro do 1o semestre". Onde estamos:


| Entrega                                                                                               | Status                  | Detalhe                                                                                                                     |
| ----------------------------------------------------------------------------------------------------- | ----------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| Revisar registro de negócios no Plia v1 (legado)                                                     | Concluído com ressalvas | Walkthrough do código e banco de dados feito em conjunto com a Bluecore. Registros parecem OK, mas Data Quality parece ruim |
...
| Criar formulário para input de conversas (piloto no Google Forms)                                   | Em andamento            | Próxima discussão semanal: Vibe Coding e futuro do Navegador                                                               |


A revisão técnica do Plia v1 (detalhada na seção 4) reforça que o caminho não é corrigir o sistema existente, e sim construir o **Navegador**.
...
- Temos **OKRs que apontam diretamente** para a construção do **Navegador**
- Temos a **confirmação de que construir fora não funciona** (experiência com o novo produto)

> **A decisão de construir o Navegador não é emocional. É informada por 6 meses de experimentação real.**
>
...
## 6. Navegador Plongê: o próximo passo natural

- Não é começar do zero. É **dar forma e interface ao que já funciona**
- É o **KR2 do pilar de Eficiência e Inovação**: desenvolver o **Navegador** como CRM operacional (dados das ações comerciais e conceito de funil)
...
**Design que aproveita o legado visual do Plia v1**
...
- Exemplo: *"Conversei com João da Petrobras sobre a vaga de CFO. Ele está interessado mas quer mais detalhes sobre remuneração"* — a **Plia** (no **Navegador**) entende quem é o contato, qual o negócio, e regista a conversa com os campos certos
- Isso resolve a dor principal dos Google Forms: o peso operacional de preencher campo por campo
- E vai além: transforma o **Navegador** num assistente de trabalho, não apenas um repositório
...
| Aprendizado do postmortem            | Como se aplica no Navegador                                            |
| ------------------------------------ | ------------------------------------------------------------------- |
...
### O novo produto mora dentro do Navegador

- **Proposta**: o produto de priorização de pipeline de candidatos (setor de Energia) deve ser construído **dentro** do **Navegador**, não com ferramentas externas
...
- Isso alinha o pilar de **Inovação e Produto** com o pilar de **Eficiência e Inovação** — o **Navegador** serve os dois
...
| Plia v1 (2022)                                  | Navegador Plongê (2026)                                                       |
| ----------------------------------------------- | ------------------------------------------------------------------- |
